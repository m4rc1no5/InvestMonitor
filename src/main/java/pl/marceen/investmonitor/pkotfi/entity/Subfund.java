...
public enum Subfund {
    ...
    LONG_TERM_BOND("4", "PKO Long-Term Bond Subfund", "PKO Obligacji Długoterminowych", 25, "1.3", "-0.5", true),
    STABLE_GROWTH("5", "PKO Stable Growth Subfund", "PKO Stabilnego Wzrostu", 21, "1.4", "-1.5", true),
    ...
    GLOBAL_NATURAL_RESOURCES("34", "PKO Global Natural Resources Subfund", "PKO Surowców Globalny", 39, "1.0", "-1.5", true),
    GLOBAL_TECHNOLOGY_AND_INNOVATION("35", "PKO Global Technology and Innovation Subfund", "PKO Technologii i Innowacji Globalny", 97, "0.9", "-1.5", true),
    GLOBAL_LUXURY_GOODS("36", "PKO Global Luxury Goods Subfund", "PKO Dóbr Luksusowych Globalny", 58, "0.8", "-1.4", true),
    ...
    JAPANESE_EQUITY("77", "PKO Japanese Equity Subfund", "PKO Akcji Rynku Japońskiego", 31, "1.3", "-0.6", true),
    GOLD_EQUITY("79", "PKO Gold Equity Subfund", "PKO Akcji Rynku Złota", 45, "0.8", "-1.2", true),
    ...
    GLOBAL_MEDICINE_AND_DEMOGRAPHY("91", "PKO Global Medicine and Demography Subfund", "PKO Medycyny i Demografii Globalny", 55, "1.3", "-1.5", true);
